python run_graph_classification.py --rewiring=panda --dataset=reddit --layer_type=PANDA-GCN --exp_factor=1.25 --centrality=degree --top_k=7 --device=0
python run_graph_classification.py --rewiring=panda --dataset=imdb --layer_type=PANDA-GCN --exp_factor=1.25 --centrality=pagerank --top_k=3 --device=0
